...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function agent($memory = null)
        {
                        /** @var \Mindwave\Mindwave\Mindwave $instance */
                        return $instance->agent($memory);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function agentWithTools($tools)
        {
                        /** @var \Mindwave\Mindwave\Mindwave $instance */
                        return $instance->agentWithTools($tools);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function agentWithToolkit($toolkit)
        {
                        /** @var \Mindwave\Mindwave\Mindwave $instance */
                        return $instance->agentWithToolkit($toolkit);
        }
                    /**
         * 
         *
...
namespace  { 
            ...
            class Mindwave extends \Mindwave\Mindwave\Facades\Mindwave {}
